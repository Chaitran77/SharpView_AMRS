...
> DB Setup
5) Setup a MySQL 8 server in line with [this guide](https://hevodata.com/learn/installing-mysql-on-ubuntu-20-04), using https://askubuntu.com/a/1406673 to overcome the `SET PASSWORD has no significance` issue (give the `root` user any secure password).
6) Create a new MySQL user `sharpview_amrs`, with hashed password `*83E60833B16CD740875DE610E8515E2C5A884A81` and standard (not administrator) privileges.
